...
> [!NOTE]
> As the platform scales, additional RIR PI blocks must be obtained for both the SRv6 locator and infrastructure loopback pools. Initiate RIR procurement well before existing allocations are exhausted.
...
SID structure, function code registry, and VRF / EVI ID semantics are defined in [SRv6 uSID Plan](../srv6/README.md).
...
Additional SRv6 locator and infrastructure loopback blocks must be registered with a RIR before existing allocations are exhausted. Initiate the process well in advance of exhaustion.
...
>
> See [SRv6 uSID Plan — Instance ID Space and Scale](../srv6/README.md#instance-id-space-and-scale) for scaling details.
